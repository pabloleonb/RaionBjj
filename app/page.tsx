                 ...
                 <div className="flex flex-col justify-between">
                    <div>
                       ...
                       <div className="space-y-6 mb-16 italic uppercase font-bold text-[10px] tracking-widest opacity-60">
                          <a href="https://www.google.com/maps/search/?api=1&query=Av.+La+Dehesa+4580,+Lo+Barnechea" target="_blank" className="flex items-center gap-4 hover:text-[#E50000] transition-colors"><MapPin className="text-[#E50000]" size={20} /> Av. La Dehesa 4580, Local 8.</a>
